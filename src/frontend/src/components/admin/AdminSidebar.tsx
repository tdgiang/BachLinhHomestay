...
export function AdminSidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className={cn('flex items-center gap-2 px-4 py-5 border-b border-white/10', collapsed && 'justify-center px-2')}>
        <div className="w-8 h-8 rounded-lg bg-[#00B4D8] flex items-center justify-center font-bold text-sm shrink-0">
          OB
        </div>
        {!collapsed && (
