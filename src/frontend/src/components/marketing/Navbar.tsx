...
import { Menu, X, Globe, LogOut, Calendar, User } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 h-16 flex items-center justify-between max-w-7xl">
        <BrandLogo showText hideTextOnMobile />
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active ? "text-white" : "hover:bg-[#F3EDE5]",
                )}
                style={
                  active
        ...
        <div className="flex items-center gap-2">
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="right" className="w-72">
              <SheetHeader>
                <SheetTitle>
                  <BrandLogo showText size="sm" asLink={false} />
                </SheetTitle>
              </SheetHeader>
