  ...
  return (
    <div style={{ background: "var(--color-surface)" }}>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #0F2D50 0%, #1A4A7A 45%, #2E6FAA 100%)",
        }}
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-24 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Từ tách cà phê sáng giữa lòng phố cổ đến buổi tối yên tĩnh sau một
              ngày dài — Ba.Li mang đến không gian nghỉ dưỡng đúng nghĩa, mọi
              lúc bạn cần.
            </p>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              <p>
                Ba.Li Homestay ra đời từ một niềm tin đơn giản:{" "}
                <strong style={{ color: "var(--color-text-primary)" }}>
                  mỗi người xứng đáng có những khoảnh khắc nghỉ ngơi thực sự
                </strong>{" "}
                — không ồn ào, không vội vã, không lo lắng.
              </p>
              <p>
                Chúng tôi bắt đầu với một căn phòng nhỏ tại Cầu Giấy, Hà Nội. Từ
                sự đón nhận nồng nhiệt của khách lưu trú, Ba.Li dần mở rộng sang
                Đống Đa và Ba Đình — mang theo cùng một triết lý:{" "}
                <em>chất lượng không thỏa hiệp, giá cả không bất ngờ</em>.
              </p>
              <p>
                Ngày nay, với hơn 20 phòng tại 3 chi nhánh Hà Nội, chúng tôi
                phục vụ hàng nghìn lượt khách mỗi năm — từ những cặp đôi tìm góc
                riêng tư, gia đình tìm kỳ nghỉ ý nghĩa, đến những bạn trẻ cần
                không gian yên tĩnh làm việc xa nhà.
              </p>
            </div>
          </div>
        </div>
              ...
              >
                ...
                <div className="relative h-52 overflow-hidden">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, rgba(15,45,80,0.5) 0%, transparent 60%)",
                    }}
                  />
            ...
            {[
              {
                icon: Clock,
                title: "Check-in 24/7",
                desc: "Đến bất cứ lúc nào, chúng tôi luôn sẵn sàng đón bạn.",
              },
              {
                icon: Shield,
                title: "Đảm bảo hoàn tiền",
                desc: "Hủy trước 48 giờ — hoàn 100% không điều kiện.",
              },
              {
                icon: Phone,
                title: "Hỗ trợ trực tiếp",
                desc: "Gọi hotline hoặc nhắn tin — phản hồi dưới 5 phút.",
              },
              ...
              <div key={title} className="flex items-start gap-4">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(145deg, rgba(26,74,122,0.1), rgba(46,111,170,0.06))",
                  }}
                >
                  <Icon
                    className="w-5 h-5"
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <p
            ...
            style={{ color: "rgba(255,255,255,0.7)" }}
          >
            Hơn 20 phòng tại 3 chi nhánh khắp Hà Nội. Đặt ngay, nhận ưu đãi sớm.
          </p>
